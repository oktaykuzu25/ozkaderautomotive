...
<head>
    ...
    <title>Marka Ekle | Özkader Otomotiv | Yönetim Paneli</title>
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="row mb-4 layout-spacing layout-top-spacing">
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form action="app-brand-add.php" method="POST" enctype="multipart/form-data">
                                <div class="widget-content widget-content-area ecommerce-create-section">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="switch form-switch-custom switch-inline form-switch-primary mt-4">
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="brand_publicy" name="brand_publicy" checked>
                                    ...
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary w-100" type="submit" name="brand-add">Marka Ekle</button>
                                    </div>
                                </div>
                            </form>
                        </div>
