...
<head>
    ...
    <title>Marka Düzenle | Özkader Otomotiv | Yönetim Paneli </title>
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="row mb-4 layout-spacing layout-top-spacing">
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form action="app-brand-edit.php" method="POST" enctype="multipart/form-data">
                                <div class="widget-content widget-content-area ecommerce-create-section">
                                    <div class="row mb-4">
                                        <div class="col-sm-9">
                                            <input type="hidden" name="brand_id" class="form-control"
                                                value="<?php echo $fetchDataBrandDetails['brand_id'] ?>">
                                            <input type="text" name="brand_name" class="form-control" id="brand_name"
                                                placeholder="Marka Ismi"
                                                value="<?php echo $fetchDataBrandDetails['brand_name'] ?>">
                                        </div>
                                        <div class="col-sm-3">
                                            <input type="text" name="brand_code" class="form-control" id="brand_code"
                                                placeholder="Marka Kodu"
                                                value="<?php echo $fetchDataBrandDetails['brand_code'] ?>">
                                        </div>
                                    </div>

                                    <div class="row mb-4">
                                        <div class="col-sm-9">
                                            <label for="brand_logo">Marka Logosu</label>
                                            <input type="file" name="brand_logo" class="form-control" id="brand_logo">
                                            <img src="../<?php echo $fetchDataBrandDetails['brand_logo'] ?>" alt="">
                                        </div>
                                        <div class="col-sm-3">
                                            <div
                                                class="switch form-switch-custom switch-inline form-switch-primary mt-4">
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="brand_publicy" name="brand_publicy"
                                                    <?php echo ($fetchDataBrandDetails['brand_publicy'] == '1') ? 'checked' : ''; ?>>
                                                <label class="switch-label" for="brand_publicy">Marka Aktifligi</label>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-sm-12">
                                        <button class="btn btn-primary w-100" type="submit" name="brand-update">Marka
                                            Guncelle</button>
                                    </div>
                                </div>
                            </form>
