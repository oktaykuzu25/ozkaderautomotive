...
<head>
    ...
    <title>Alt Kategori Ekle | Özkader Otomotiv | Yönetim Paneli</title>
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="row mb-4 layout-spacing layout-top-spacing">
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form action="app-lower-category-add.php" method="POST">
                                <div class="widget-content widget-content-area ecommerce-create-section">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-9">
                                            ...
                                            <select class="form-select" id="upper_category_id" name="upper_category_id"
                                                ...
                                                if (is_array($fetchDataUpperCategory)) {
                                                    foreach ($fetchDataUpperCategory as $data) {
                                                        $selected = ($data['upper_category_name'] == $fetchDataUpperCategoryDetails['upper_category_name']) ? 'selected' : '';
                                                ?>
                                            ...
                                            <input type="hidden" name="upper_category_id"
                                                value="<?php echo $fetchDataUpperCategoryDetails['upper_category_id']; ?>">
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div
                                                ...
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="lower_category_publicy" name="lower_category_publicy" checked>
                                    ...
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary w-100" type="submit"
                                            name="lower-category-add">Alt Kategori
                                            Ekle</button>
                                    </div>
                                </div>
                            </form>
