                                            ...
                                            <td>
                                                <div class="d-flex justify-content-left align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <span class="text-truncate fw-bold"><?php echo $data['brand_name'] ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item" href="app-brand-edit.php?<?php echo $url ?>">Düzenle</a>
                                                        <a class="dropdown-item" href="app-brand-list.php?deleteBrand=<?php echo $data['brand_id']; ?>">Sil</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
