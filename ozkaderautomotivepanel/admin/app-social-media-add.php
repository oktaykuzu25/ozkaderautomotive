...
<head>
    ...
    <title>instagram Ekle | Özkader Otomotiv | Yönetim Paneli</title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">İnstagram Ekle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form action="app-social-media-add.php" method="POST" enctype="multipart/form-data">
                                <div class="widget-content widget-content-area ecommerce-create-section">
                                    <div class="row mb-4">
                                        <div class="col-sm-9">
                                            <input type="text" name="instagram_url" class="form-control" id="brand_name"
                                                placeholder="instagram urlinizi giriniz.">
                                        </div>
                                        <div class="col-sm-3">
                                            <input type="text" name="instagram_name" class="form-control" id="brand_code"
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-9">
                                            <label for="brand_logo">İnstagram Fotosu</label>
                                            <input type="file" name="instagram_foto" class="form-control" id="brand_logo">
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="switch form-switch-custom switch-inline form-switch-primary mt-4">
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="brand_publicy" name="instagram_publicy" checked>
                                    ...
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary w-100" type="submit" name="instagram-add">İnstagram Ekle</button>
                                    </div>
                                </div>
                            </form>
                        </div>
