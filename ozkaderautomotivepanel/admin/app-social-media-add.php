            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="#socialMedia" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                ...
                                <div class="widget-content widget-content-area ecommerce-create-section">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" name="instagram_name" class="form-control"
                                                id="brand_code" placeholder="Instagram Kullanıcı Adı">
                                        </div>
                                    </div>

                                    <div class="row mb-4">
                                        <div class="col-sm-9">
                                            <label for="brand_logo">Instagram Fotosu</label>
                                            <input type="file" name="instagram_foto" class="form-control"
                                                id="brand_logo">
                                        </div>
                                        <div class="col-sm-3">
                                            <div
                                                ...
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="instagram_publicy" name="instagram_publicy" checked>
                                                <label class="switch-label" for="instagram_publicy">Instagram
                                                    Aktifliği</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary w-100" type="submit"
                                            name="instagram-add">İnstagram Ekle</button>
                                    </div>
                                </div>
                            </form>
                        </div>
