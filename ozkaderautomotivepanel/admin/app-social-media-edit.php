...
<head>
    ...
    <title>Instagram Duzenle | Özkader Otomotiv | Yönetim Paneli</title>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <<li class="menu">
                        ...
                        <li class="menu active">
                            <a href="#socialMedia" data-bs-toggle="collapse" aria-expanded="true"
                                class="dropdown-toggle">
                                <div class="">
                                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul class="collapse submenu list-unstyled show" id="socialMedia"
                                data-bs-parent="#accordionExample">
                                <li>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" name="instagram_name" class="form-control"
                                                id="instagram_name" placeholder="Instagram Kullanıcı Adı"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-3">
                                            <div
                                                ...
                                                <label class="switch-label" for="instagram_publicy">Instagram Aktifliği</label>
                                            </div>
                                        </div>
                                    </div>
