...
<head>
    ...
    <title>İnstagram Duzenle | Özkader Otomotiv | Yönetim Paneli</title>
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">İnstagram Duzenle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row mb-4 layout-spacing layout-top-spacing">
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form action="app-social-media-edit.php" method="POST" enctype="multipart/form-data">
                                <div class="widget-content widget-content-area ecommerce-create-section">
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            <input type="text" name="instagram_url" class="form-control"
                                                id="instagram_url" placeholder="İnstagram url "
                                                value="<?php echo $fetchDataEditİnstagramDetails['instagram_url'] ?>">
                                                
                                            <input type="hidden" name="instagram_id"
                                                value="<?php echo $fetchDataEditİnstagramDetails['instagram_id'] ?>">
                                        </div>

                                        
                                    </div>
                                    <div class="col-sm-6">
                                            <input type="text" name="instagram_name" class="form-control"
                                                id="instagram_name" placeholder="İnstagram Adı "
                                                value="<?php echo $fetchDataEditİnstagramDetails['instagram_name'] ?>">
                                    
                                        </div>
                                        <br>
                                    <div class="row mb-4">
                                        <div class="col-sm-9">
                                            <label for="upper_category_photo">İnstagram Fotografi</label>
                                            <input type="file" name="intagram_foto" class="form-control"
                                                id="intagram_foto">
                                            <img src="../<?php echo $fetchDataEditİnstagramDetails['instagram_foto'] ?>"
                                                alt="">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div
                                                ...
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="instagram_publicy" name="instagram_publicy"
                                                    <?php echo ($fetchDataEditİnstagramDetails['instagram_publicy'] == '1') ? 'checked' : ''; ?>  >
                                                <label class="switch-label"
                                                    for="instagram_publicy">Aktiflik</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary w-100" type="submit"
                                            name="instagram-update">İnstagram Güncelle</button>
                                    </div>
                                </div>
                            </form>
                        </div>
