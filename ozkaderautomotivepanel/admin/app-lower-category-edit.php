...
<head>
    ...
    <title>Alt Kategori Duzenle | Özkader Otomotiv | Yönetim Paneli</title>
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Alt Kategori</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Alt Kategori Duzenle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row mb-4 layout-spacing layout-top-spacing">
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form action="app-lower-category-edit.php" method="POST">
                                <div class="widget-content widget-content-area ecommerce-create-section">

                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            <input type="text" name="lower_category_name" class="form-control"
                                                id="lower_category_name" placeholder="Alt Kategori Ismi"
                                                value="<?php echo $fetchDataLowerCategoryDetails['lower_category_name'] ?>">
                                                <input type="hidden" name="lower_category_id" class="form-control"
                                                value="<?php echo $fetchDataLowerCategoryDetails['lower_category_id'] ?>">
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-select" id="upper_category_id" name="upper_category_id">
                                                ...
                                                if (is_array($fetchDataUpperCategory)) {
                                                    foreach ($fetchDataUpperCategory as $data) {
                                                        $selected = ($data['upper_category_id'] == $fetchDataLowerCategoryDetails['upper_category_id']) ? 'selected' : '';
                                                ?>
                                                <option class="form-select"
                                                    value="<?php echo $data['upper_category_id'] ?>"
                                                    <?php echo $selected ?>><?php echo $data['upper_category_name'] ?>
                                                </option>
                                                <?php
                                                    }
                                                } else {
                                        ...
                                        <div class="col-sm-3">
                                            <div
                                                ...
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="lower_category_publicy" name="lower_category_publicy"
                                                    <?php echo ($fetchDataLowerCategoryDetails['lower_category_publicy'] == '1') ? 'checked' : ''; ?>>
                                                <label class="switch-label"
                                                    for="lower_category_publicy">Aktiflik</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary w-100" type="submit"
                                            name="lower-category-update">Alt Kategori
                                            Ekle</button>
                                    </div>
                                </div>
                            </form>
