...
<head>
    ...
    <title>Ürün Ekle | Özkader Otomotiv | Yönetim Paneli</title>
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form action="app-product-add.php" method="POST" enctype="multipart/form-data">
                                <div class="widget-content widget-content-area ecommerce-create-section">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-9">
                                            <label for="product_name">Urun Ismi</label>
                                            <input type="text" name="product_name" class="form-control"
                                                id="product_name">
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="product_code">Urun Kodu</label>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-9">
                                            <label for="product_photo">Urun Fotografi 835x675</label>
                                            <input type="file" name="product_photo" class="form-control"
                                                id="product_photo">
                                        </div>

                                        <div class="col-sm-3">
                                            <label for="product_manufacturer_code">Urun Uretici Kodu</label>
                                            <input type="text" name="product_manufacturer_code" class="form-control"
                                                id="product_manufacturer_code">
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-6 mb-4">
                                            <label for="upper_category_id">Ust Kategori</label>
                                            <select class="form-select" id="upper_category_id" name="upper_category_id">
                                                <option class="form-select">Seciniz</option>
                                                <?php
                                                if (is_array($fetchDataUpperCategory)) {
                                                    foreach ($fetchDataUpperCategory as $data) {
                                                ?>
                                                        <option class="form-select"
                                                            value="<?php echo $data['upper_category_id'] ?>">
                                                            <?php echo $data['upper_category_name'] ?>
                                                        </option>
                                                <?php
                                                    }
                                                } else {
                                        ...
                                        <div class="col-sm-6 mb-4">
                                            <label for="lower_category_id">Alt Kategori</label>
                                            <select class="form-select" id="lower_category_id"
                                                name="lower_category_id">
                                                <option class="form-select">Seciniz</option>
                                                <?php
                                                ...
                                                ?>
                                                        <option class="form-select"
                                                            value="<?php echo $data['lower_category_id'] ?>">
                                                            <?php echo $data['lower_category_name'] ?>
                                                        </option>
                                                <?php
                                                    }
                                                } else {
                                        ...
                                        <div class="col-sm-12 mb-4">
                                            <label for="brand_id">Markalar</label>
                                            <select class="form-select" id="brand_id" name="brand_id">
                                                ...
                                                ?>
                                                        <option class="form-select" value="<?php echo $data['brand_id'] ?>">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="switch form-switch-custom switch-inline form-switch-primary mt-4">
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="product_publicy" name="product_publicy" checked>
                                                <label class="switch-label" for="product_publicy">Urun Aktifligi</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="switch form-switch-custom switch-inline form-switch-primary mt-4">
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="product_stock_status" name="product_stock_status" checked>
                                                <label class="switch-label" for="product_stock_status">Stok Durumu</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="switch form-switch-custom switch-inline form-switch-primary mt-4">
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="product_slider_status" name="product_slider_status">
                                                <label class="switch-label" for="product_slider_status">Slider Durumu</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="switch form-switch-custom switch-inline form-switch-primary mt-4">
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="product_featured_status" name="product_featured_status">
                                                <label class="switch-label" for="product_featured_status">One Cikan Durumu</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            <label for="product_slider_photos">Slider Fotografi 1920x1080</label>
                                            <input type="file" name="product_slider_photos" class="form-control"
                                                id="product_slider_photos">
                                        </div>

                                    </div>

                                    <div class="col-sm-12">
                                        <button class="btn btn-primary w-100" type="submit" name="product-add">Urun
                                            Ekle</button>
                                    </div>
                                </div>
                            </form>
