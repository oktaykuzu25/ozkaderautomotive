...
<head>
    ...
    <title>Galeri Görseli Ekle | Özkader Otomotiv | Yönetim Paneli</title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Galeri Görseli Ekle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form action="app-social-media-add.php" method="POST" enctype="multipart/form-data">
                                <div class="widget-content widget-content-area ecommerce-create-section">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-6">
                                            <label for="gallery_name">Fotoğraf İsim</label>
                                            <input type="text" name="gallery_name" class="form-control"
                                                id="gallery_name" placeholder="Fotoğraf İsim">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="gallery_foto">Galeri Görseli</label>
                                            <input type="file" name="gallery_foto" class="form-control"
                                                id="gallery_foto">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            <button class="btn btn-primary w-100" type="submit"
                                                name="gallery-add">Galeri Görseli Ekle</button>
                                        </div>
                                    </div>
                            </form>
                        </div>
