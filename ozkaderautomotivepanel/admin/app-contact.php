            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="#contact" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        ...
                        <ul class="collapse submenu list-unstyled show" id="contact" data-bs-parent="#accordionExample">
                            <li class="active">
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form action="app-contact.php" method="POST" enctype="multipart/form-data">
                                <div class="widget-content widget-content-area ecommerce-create-section">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-6">
                                            <label for="contact_district">İlçe</label>
                                            <input type="text" name="contact_district" class="form-control"
                                                id="contact_district"
                                                value="<?php echo $fetchDataContact[0]['contact_district']; ?>">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="contact_address">Açık Adresi</label>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-6">
                                            <label for="contact_address_url">Contact URL</label>
                                            <input type="text" name="contact_address_url" class="form-control"
                                                id="contact_address_url"
                                                value="<?php echo $fetchDataContact[0]['contact_address_url']; ?>">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="contact_address_url_iframe">Contact URL Iframe</label>
                                            <input type="text" name="contact_address_url_iframe" class="form-control"
                                                id="contact_address_url_iframe"
                                    ...
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary w-100" type="submit"
                                            name="contact-update">İletişim Bilgilerini Güncelle</button>
                                    </div>
                                </div>
                            </form>
                        </div>
