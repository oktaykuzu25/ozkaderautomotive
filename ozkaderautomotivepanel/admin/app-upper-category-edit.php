...
<head>
    ...
    <title>Ust Kategori Duzenle | Özkader Otomotiv | Yönetim Paneli</title>
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ust Kategori Duzenle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row mb-4 layout-spacing layout-top-spacing">
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form action="app-upper-category-edit.php" method="POST" enctype="multipart/form-data">
                                <div class="widget-content widget-content-area ecommerce-create-section">
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            <input type="text" name="upper_category_name" class="form-control"
                                                ...
                                                value="<?php echo $fetchDataUpperCategoryDetails['upper_category_name'] ?>">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-9">
                                            ...
                                            <img src="../<?php echo $fetchDataUpperCategoryDetails['upper_category_photo'] ?>"
                                                alt="">
                                        ...
                                        <div class="col-sm-3">
                                            <div
                                                ...
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="upper_category_publicy" name="upper_category_publicy"
                                                    <?php echo ($fetchDataUpperCategoryDetails['upper_category_publicy'] == '1') ? 'checked' : ''; ?>>
                                    ...
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary w-100" type="submit"
                                            name="upper-category-update">Ust Kategori
                                            Ekle</button>
                                    </div>
                                </div>
                            </form>
