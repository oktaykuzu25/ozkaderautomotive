...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>404 | Özkader Otomotiv</title>
    <style>
        #whiteText {
            color: white;
        }
...
<body>
    ...
    <div id="wrapperParallax" class="wrapper clearfix">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarContent1">
                        <ul class="navbar-nav ml-auto mr-auto">
                            <!-- home Menu -->
                            <li class="active">
                                <a href="index.php" class="menu-item" id="whiteText">Anasayfa</a>
                            </li>
                            <!-- Pages Menu -->
                            <li>
                                <a href="about.php" class="menu-item" id="whiteText">Hakkımızda</a>
                            </li>
                            <!-- Pages Menu -->
                            <!-- shop Menu -->
                            <li>
                                <a href="brand.php" class="menu-item" id="whiteText">Markalar</a>
                            </li>
                        </ul>
                    ...
                    <div class="collapse navbar-collapse" id="navbarContent2">
                        <ul class="navbar-nav mr-auto ml-auto">
                            ...
                            <li class="has-dropdown mega-dropdown">
                                <a href="#" data-toggle="dropdown" class="dropdown-toggle menu-item" id="whiteText">Kategori</a>
                            ...
                            <li class="has-dropdown">
                                <a href="gallery.php" class="menu-item" id="whiteText">
                                    Galeri</a>
                            </li><!-- li end -->

                            <!-- Blog Menu-->
                            <li class="has-dropdown">
                                <a href="contact.php" class="menu-item" id="whiteText">
                                    İletişim</a>
                            </li><!-- li end -->
        ...
        <!--404
=============================================-->
        <section class="page-404 text-center mtop-100 bg-parallax">
            <div class="bg-section" style="opacity: 0.9;">
                <img src="assets/images/background/404-background.webp" alt="background">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <h3>404</h3>
                        <h4 id="whiteText">Oh! Sayfa Bulunamadı</h4>
                        <p id="whiteText">ARADIĞINIZ SAYFA YOK</p>
